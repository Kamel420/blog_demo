    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item active">
         ...
         <li class="nav-item active">
            ...
            <a class="nav-link" href="{{ route('admin.create') }}"><i class="icon-plus-sign-alt"></i> New Post <span class="sr-only">(current)</span></a>
            @else
            <a class="nav-link" href="{{ route('admin.index') }}"><i class="icon-backward"></i> All Categories <span class="sr-only">(current)</span></a>
            @endif
        </li>
        </ul>
    </div>
